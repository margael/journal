...
Now my biggest challenge is hosting the site on github pages. I tried to host it 3 different time and everytime the pages have not renderedwith the html/css. I'm not really sure what to do anymore. As a human being who's been really trying to create something I've never done before and having been met with so many challenges, I've reached the point where for my own mental health, I am choosing to submit this project as if even though it isn't what I want it to be.
...
The website has three pages and 3 blog posts and and embedded twitter feed. The blog posts are accessible from the welcome page. The pages are accessible from the navigation bar in the header. Here are some captures from the site.
    ...
    <br>
    <br>
    <p> fig 1. This is a screencapture of the welcome page.
    <img src="index.jpg" style="width:600px;height:auto;border-radius:15px; opacity:.6;"> </p>
    <p> fig 2. This is a screen capture of the about page
    <img src="about.jpg" style="width:600px;height:auto;border-radius:15px; opacity:.6;"> </p>
    <p> fig 3. This is a screen capture of the history page
    <img src="history.jpg" style="width:600px;height:auto;border-radius:15px; opacity:.6;"> </p>
    <p> fig 4. This is a screen capture of the post title The Participants
    <img src="participants.jpg" style="width:600px;height:auto;border-radius:15px; opacity:.6;"> </p>
    ...
    <img src="hover.jpg" style="width:600px;height:auto;border-radius:15px; opacity:.6;"> </p>
</body>
</html>
